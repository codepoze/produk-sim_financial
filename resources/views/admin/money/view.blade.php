<x-admin-layout title="{{ $title }}">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table" id="tabel-money-dt"></table>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-add-upd" action="{{ route('admin.money.save') }}" method="POST">
                        <!-- begin:: id -->
                        <input type="hidden" name="id_money" id="id_money" />
                        <!-- end:: id -->
                        ...
                        <div id="form-show">
                            ...
                            <div class="mb-3 row field-input">
                                ...
                                <div class="col-md-9 my-auto">
                                    <textarea name="description" id="description" class="form-control form-control-sm" placeholder="Masukkan deskripsi"></textarea>
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="mb-3 row field-input">
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-money-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
