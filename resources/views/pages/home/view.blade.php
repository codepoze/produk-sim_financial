                ...
                <div class="col-lg-6 col-md-12 order-lg-1">
                    <div class="banner-img p-0">
                        <div class="rounded box-shadow position-relative wow animate__fadeInRight animate__slow">
                            <img class="img-fluid rounded" src="{{ asset_pages('images/banner/01.jpg') }}" alt="">
                            <a class="video-btn is-play video-btn-pos popup-youtube" href="https://www.youtube.com/watch?v=P_wKDMcr1Tg">
                                ...
                                <div class="video-btn-icon is-play">
                                    <svg height="100%" width="100%">
                                        ...
                                        <path class="path" d="M5,0 L30,15 L5,30z" fill="none" stroke-width="1">
                                        </path>
                                    </svg>
                                </div>
                            </a>
    ...
    <div class="page-content">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <img class="img-fluid" src="{{ asset_pages('images/about/03.png') }}" alt="">
                    </div>
                    <div class="col-lg-6 col-md-12 mt-6 mt-lg-0 ps-lg-10">
                        ...
                        <p class="mb-5">Scale your software operations through a custom engineering team. Meet the
                            demand of your company’s operations with a high-performing nearshore team skilled in the
                            technologies you need.</p>
                            ...
                            <div class="row">
                                    ...
                                    <div class="service-item style-2">
                                        <div class="service-top">
                                            <div class="service-images">
                                                <img class="img-fluid" src="{{ asset_pages('images/service-icon/01.png') }}" alt="">
                                            </div>
                                ...
                                <div class="col-md-6 mt-4 mt-md-0">
                                    <div class="service-item style-2">
                                        <div class="service-top">
                                            <div class="service-images">
                                                <img class="img-fluid" src="{{ asset_pages('images/service-icon/02.png') }}" alt="">
                                            </div>
                                            <div class="service-title">
                                                <h4>Data Security</h4>
                                            </div>
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="service-item style-2">
                                        <div class="service-top">
                                            <div class="service-images">
                                                <img class="img-fluid" src="{{ asset_pages('images/service-icon/03.png') }}" alt="">
                                            </div>
                                            <div class="service-title">
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="service-item style-2">
                                        <div class="service-top">
                                            <div class="service-images">
                                                <img class="img-fluid" src="{{ asset_pages('images/service-icon/05.png') }}" alt="">
                                            </div>
                                            <div class="service-title">
                                                <h4>Development</h4>
                                            </div>
        ...
        <section>
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="owl-carousel" data-items="4" data-md-items="2" data-sm-items="1" data-margin="30" data-autoplay="true">
                            <div class="item">
                                <div class="team-member">
                                    <div class="team-images">
                                        <img class="img-fluid rounded" src="{{ asset_pages('images/team/01.jpg') }}" alt="">
                            ...
                            <div class="item">
                                <div class="team-member">
                                    <div class="team-images">
                                        <img class="img-fluid rounded" src="{{ asset_pages('images/team/02.jpg') }}" alt="">
                                        <div class="social-icons team-social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#">
                            ...
                            <div class="item">
                                <div class="team-member">
                                    <div class="team-images">
                                        <img class="img-fluid rounded" src="{{ asset_pages('images/team/03.jpg') }}" alt="">
                                        <div class="social-icons team-social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#">
                            ...
                            <div class="item">
                                <div class="team-member">
                                    <div class="team-images">
                                        <img class="img-fluid rounded" src="{{ asset_pages('images/team/04.jpg') }}" alt="">
                                        <div class="social-icons team-social-icon">
                                            <ul>
                                                <li>
                                                    <a href="#">
        ...
        <section class="light-bg" data-bg-img="{{ asset_pages('images/bg/02.png') }}">
            <div class="container">
                <div class="row">
                                ...
                                <div class="price-table">
                                    <div class="price-header">
                                        ...
                                        <div class="price-icon">
                                            <img class="img-fluid" src="{{ asset_pages('images/price-icon/01') }}.png" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-12 mt-6 mt-lg-0">
                                <div class="price-table">
                                    <div class="price-header">
                                        ...
                                        <div class="price-icon">
                                            <img class="img-fluid" src="{{ asset_pages('images/price-icon/02') }}.png" alt="">
                                        </div>
                                    </div>
                                    <p>Our plans come with a 100% free 14 day trial. No credit card needed.</p>
                                    <div class="price-list">
                        ...
                        <div class="row">
                                ...
                                <div class="testimonial style-1">
                                    <div class="testimonial-media">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset_pages('images/testimonial/01.jpg') }}" alt="">
                                        </div>
                            ...
                            <div class="col-md-6 mt-10 mt-md-0">
                                <div class="testimonial style-1">
                                    <div class="testimonial-media">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset_pages('images/testimonial/02.jpg') }}" alt="">
                                        </div>
                                        <div class="testimonial-quote">
                                            <i class="flaticon flaticon-quote"></i>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-10">
                                <div class="testimonial style-1">
                                    <div class="testimonial-media">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset_pages('images/testimonial/03.jpg') }}" alt="">
                                        </div>
                                        <div class="testimonial-quote">
                                            <i class="flaticon flaticon-quote"></i>
                                        </div>
                            ...
                            <div class="col-md-6 mt-10 mt-md-0">
                                <div class="testimonial style-1">
                                    <div class="testimonial-media">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset_pages('images/testimonial/04.jpg') }}" alt="">
                                        </div>
                                        <div class="testimonial-quote">
                                            <i class="flaticon flaticon-quote"></i>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="post-card">
                            <div class="post-image">
                                <img class="img-fluid w-100" src="{{ asset_pages('images/blog/01.jpg') }}" alt="">
                            </div>
                            <div class="post-desc">
                                <div class="post-meta">
                    ...
                    <div class="col-lg-4 col-md-12 mt-6 mt-lg-0">
                        <div class="post-card">
                            <div class="post-image">
                                <img class="img-fluid w-100" src="{{ asset_pages('images/blog/02.jpg') }}" alt="">
                            </div>
                            <div class="post-desc">
                                <div class="post-meta">
                                    <ul class="list-inline">
                    ...
                    <div class="col-lg-4 col-md-12 mt-6 mt-lg-0">
                        <div class="post-card">
                            <div class="post-image">
                                <img class="img-fluid w-100" src="{{ asset_pages('images/blog/03.jpg') }}" alt="">
                            </div>
                            <div class="post-desc">
                                <div class="post-meta">
                                    <ul class="list-inline">
